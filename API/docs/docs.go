...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.GroupEventWithDetails"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.GroupWithOwner"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/v1/groups/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Group details (title, description, invitees)",
                        "name": "group",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.GroupInviteWithDetails"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/v1/groups/invites/{id}/accept": {
            "put": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/v1/groups/invites/{id}/decline": {
            "put": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/v1/groups/requests/{id}/approve": {
            "put": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/v1/groups/requests/{id}/deny": {
            "put": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.GroupEvent"
                            }
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.GroupMemberWithUser"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.GroupJoinRequest"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.GroupJoinRequestWithDetails"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/v1/posts/create": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Post visibility: public (default), followers, or private",
                        "name": "visibility",
                        "in": "formData"
                    },
                    {
        ...
        "/api/v1/posts/update-visibility/{id}": {
            "put": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "status: visibility updated",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "400": {
                        "description": "Invalid request or invalid visibility",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/posts/{id}/add-allowed-user": {
            "post": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/v1/posts/{id}/remove-allowed-user": {
            "post": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "status: user removed",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.PostWithUser"
                            }
                        }
                    },
                    "401": {
    ...
    "definitions": {
        ...
        "models.EventOptionWithVotes": {
            "type": "object",
            "properties": {
                "event_id": {
                    "description": "The ID of the event this option belongs to\nexample: e1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6",
                    "type": "string"
                },
                "id": {
                    "description": "The unique identifier for the option (UUID)\nexample: o1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6",
                    "type": "string"
                },
                "label": {
                    "description": "The label for this option: going, not going, maybe\nexample: going",
                    "type": "string"
                },
                "user_voted": {
        ...
        "models.GroupEvent": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "The unique identifier for the event (UUID)\nexample: e1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6",
                    "type": "string"
                },
                "title": {
        ...
        "models.GroupEventWithDetails": {
            ...
            "properties": {
                ...
                "options": {
                    "description": "The RSVP options with vote counts",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EventOptionWithVotes"
                    }
                },
                "title": {
                    "description": "The title of the event\nexample: Photo Walk in Central Park",
                ...
                "user_vote": {
                    "description": "The option ID the current user voted for (if any)\nexample: o1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6",
                    "type": "string"
                }
            }
        },
        "models.GroupInvite": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "The unique identifier for the invite (UUID)\nexample: i1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6",
                    "type": "string"
                },
                "responded_at": {
                    "description": "The timestamp when the invite was responded to\nexample: 2025-12-29T19:30:00Z",
                    "type": "string"
                },
                "status": {
                    "description": "The status of the invite: pending, accepted, declined\nexample: pending",
                    "type": "string"
                },
                "to_user_id": {
        ...
        "models.GroupInviteWithDetails": {
            ...
            "properties": {
                ...
                "from_nickname": {
                    "description": "The display name of the user who sent the invite\nexample: photo_master",
                    "type": "string"
                },
                "from_user_id": {
                    "description": "The ID of the user who sent the invite\nexample: a1b2c3d4-e5f6-g7h8-i9j0-k1l2m3n4o5p6",
                ...
                "to_nickname": {
                    "description": "The display name of the user who received the invite\nexample: johndoe_99",
                    "type": "string"
                },
                "to_user_id": {
                    "description": "The ID of the user who received the invite\nexample: b2c3d4e5-f6g7-h8i9-j0k1-l2m3n4o5p6q7",
        ...
        "models.GroupJoinRequest": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "The unique identifier for the request (UUID)\nexample: r1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6",
                    "type": "string"
                },
                "responded_at": {
                    "description": "The timestamp when the request was responded to\nexample: 2025-12-29T19:30:00Z",
                    "type": "string"
                },
                "status": {
                    "description": "The status of the request: pending, approved, denied\nexample: pending",
                    "type": "string"
                },
                "user_id": {
        ...
        "models.GroupJoinRequestWithDetails": {
            "type": "object",
            "properties": {
                "created_at": {
                    "description": "The timestamp when the request was created\nexample: 2025-12-29T18:00:00Z",
        ...
        "models.GroupMemberWithUser": {
            ...
            "properties": {
                ...
                "is_owner": {
                    "description": "Whether this user is the owner of the group\nexample: false",
                    "type": "boolean"
                },
                "joined_at": {
                    "description": "The timestamp when the user joined the group\nexample: 2025-12-29T18:00:00Z",
                    "type": "string"
                },
                "last_name": {
                    "description": "The user's last name\nexample: Doe",
        ...
        "models.GroupWithOwner": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "The unique identifier for the group (UUID)\nexample: g1a2b3c4-d5e6-f7g8-h9i0-j1k2l3m4n5o6",
                    "type": "string"
                },
                "member_count": {
        ...
        "models.PostWithUser": {
            ...
            "properties": {
                ...
                "image_url": {
                    "description": "URL to the full-size image attached to the post\nexample: /uploads/images/posts/7b1a2c3d.jpg",
                    "type": "string"
                },
                "nickname": {
                ...
                "updated_at": {
                    "description": "example: 2025-12-29T19:30:00Z",
                    "type": "string"
                },
                "user_id": {
                ...
                "visibility": {
                    "description": "The visibility of the post: public, followers, or private\nexample: public",
                    "type": "string"
                }
            }
        },
