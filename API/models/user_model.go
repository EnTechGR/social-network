...
// UserWithAvatar extends User with avatar information retrieved from images_core
// swagger:model UserWithAvatar
type UserWithAvatar struct {
	User
	// Avatar information retrieved from images_core via user_avatars relationship
	Avatar *AvatarInfo `json:"avatar,omitempty"`
}

// AvatarInfo represents user avatar image details
...
type UserRegistration struct {
	...
	// example: false
	IsPrivate bool `json:"is_private"`
	// Note: Avatar is now uploaded separately via multipart/form-data
	// and is not part of this JSON structure
}
...
type UserProfile struct {
	...
	User User `json:"user"`
	// Avatar information (if available)
	Avatar *AvatarInfo `json:"avatar,omitempty"`
